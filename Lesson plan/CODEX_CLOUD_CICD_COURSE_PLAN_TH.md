...
## Track Override — Fast-track Learning Pace (15 กรกฎาคม 2026)

ปรับจังหวะการเรียนให้เร็วขึ้นตามความต้องการของผู้เรียน โดยใช้หลักการนี้แทนจังหวะละเอียดเดิม:

- อธิบายสั้น เฉพาะเหตุผลและจุดที่ต้องระวัง ถ้าผู้เรียนสงสัยค่อยขยาย
- ทำงานเป็นก้อนระดับบทหรือความสามารถ ไม่ commit/push ทุกขั้นย่อย
- หนึ่งบทควรมี commit/push หลักเพียง 1 ครั้ง เว้นแต่มีเหตุจำเป็น เช่น PR, conflict, release, หรือ rollback
- Secret scan ทำเฉพาะก่อน push/PR/release, เมื่อแตะ config/cloud/secret, หรือเมื่อมีความเสี่ยงจริง
- Learning log บันทึกเฉพาะ decision, error สำคัญ, test result, command สำคัญ หรือสิ่งที่ผู้เรียนยังสงสัย
- Checklist ใช้ปิดบท ไม่ต้องอัปเดตทุก micro-step
- Acceptance Criteria ยังต้องผ่าน แต่ไม่ต้องทำพิธีตรวจซ้ำถ้าไม่มีความเสี่ยงเพิ่ม

เป้าหมายใหม่คือเรียนให้ไหลขึ้น โดยยังรักษาความปลอดภัย ค่าใช้จ่าย 0 บาท และหลักฐานสำคัญพอให้ย้อนดูได้
